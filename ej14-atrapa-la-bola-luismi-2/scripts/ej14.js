...
let records = localStorage.getItem("atrapaBolaRecords")         //sacar lo que hay en atrapaBolaRecords
if (records) {  //es distinto de null
...
function decrementarSegundos() {
    ...
    if (tiempo.textContent == "0") {
        ...
        if (puntos.textContent > records[records.length - 1].points) {
            ...
            if (!nick) nick = "Anónimo"         //si nick es null, el valor de nick será "Anónimo"
